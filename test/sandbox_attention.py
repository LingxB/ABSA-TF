...
dm = AttDataManager(batch_size=32)
...
with tf.Session() as sess:
    ...
    for epoch in range(epochs):
        ...
        for _X,_asp,_y in generator:
            _, train_loss, train_acc = sess.run([train_op, cross_entropy, accuracy], feed_dict=feed_dict(_X,_asp,_y))
        ...
        test_loss, test_acc = sess.run([cross_entropy, accuracy], feed_dict=feed_dict(X_,asp_,y_))
